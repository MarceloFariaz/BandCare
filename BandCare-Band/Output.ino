...
void output_angles()
{
  ...
  else if (output_format == OUTPUT__FORMAT_TEXT)
  {
      ...
      dpr[0] = dpr[0] - TO_DEG(yaw);
      dpr[1] = dpr[1] - TO_DEG(pitch);
      dpr[2] = dpr[2] - TO_DEG(roll);
    
//    Serial.print(dpr[0] - TO_DEG(yaw)); Serial.print("\t");
//    Serial.print(dpr[1] - TO_DEG(pitch)); Serial.print("\t");
//    Serial.print(dpr[2] - TO_DEG(roll)); Serial.println();
//    
//    ss.print(dpr[0] - TO_DEG(yaw)); ss.print("\t");
//    ss.print(dpr[1] - TO_DEG(pitch)); ss.print("\t");
//    ss.print(dpr[2] - TO_DEG(roll)); ss.println();

    dpr[0] += dpr[1] + dpr[2];
    dpr[0] /= 3;

    Serial.println(dpr[0] > 0 ? dpr[0] : - dpr[0]);
    randomSeed(analogRead(5));
    Serial.println(100 + random(10));
